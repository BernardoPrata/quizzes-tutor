...
PS - the tests ran locally but sometimes there is a problem with the folder where the screenshots are saved. Sometimes the screenshots are stored in the `tests/e2e/screenshots/currentCourseExectutionDashboard.js`.
